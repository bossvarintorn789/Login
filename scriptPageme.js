...
const clientId = "2001426135"; // channel's client ID LIFF-Boss789
const clientSecret = '7c04481703ae09ab574fc39d74bf7d55'; // channel's Secret LIFF-Boss789
...
async function addHitoryLogin(user) {
  ...
  const URL = "https://script.google.com/macros/s/AKfycbyLoQz9YXxRwhINVjB0BaY-hdxnnnaa8a2pj0BP6XNF_jG-g1P84hjFZDZrTiaoHFAm-Q/exec"
  let sendObj = {}
...
async function chkUser(user, accessToken) {
  ...
  let rescheck = false
        ...
        loadend() 
            ...
            title: 'กรุณา ยืนยันอีเมลของท่านเพื่อเข้าใช้งาน',
            html:
